...
export const NewChatIcon = (props: IconProps): JSX.Element => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
...
export const ChatBubbleIcon = (props: IconProps): JSX.Element => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
...
export const AlignIcon = (props: IconProps): JSX.Element => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={props.size || 24}
...
export const UpIcon = (props: IconProps): JSX.Element => {
    return (
        <svg
            class="w-4 h-4"
            fill="none"
